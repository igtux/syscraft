...
export async function seed(): Promise<void> {
  ...
  const settings = [
    ...
    { key: 'satellite_activation_key', value: 'ailab-rhel9', description: 'Activation key used when registering hosts with Satellite.' },
    { key: 'satellite_organization', value: 'ailab', description: 'Satellite organization name for host registration.' },
